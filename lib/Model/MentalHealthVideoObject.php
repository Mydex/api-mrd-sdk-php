...
/**
 * MentalHealthVideoObject Class Doc Comment
 *
 * @category Class
 * @description Video content included within a Mental Health page. VideoObject entries are passed through without content formatting.
 * @package  Mydex\ApiMrdSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MentalHealthVideoObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MentalHealthVideoObject';
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position < 0)) {
            throw new \InvalidArgumentException('invalid value for $position when calling MentalHealthVideoObject., must be bigger than or equal to 0.');
        }
