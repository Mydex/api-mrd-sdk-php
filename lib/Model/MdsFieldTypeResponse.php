...
/**
 * MdsFieldTypeResponse Class Doc Comment
 *
 * @category Class
 * @description Field name, display name and data type for an individual MDS field.
 * @package  Mydex\ApiMrdSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MdsFieldTypeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MdsFieldTypeResponse';
