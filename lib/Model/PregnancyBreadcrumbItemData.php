...
/**
 * PregnancyBreadcrumbItemData Class Doc Comment
 *
 * @category Class
 * @package  Mydex\ApiMrdSdk
 * @author   OpenAPI Generator team
 ...
 */
class PregnancyBreadcrumbItemData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PregnancyBreadcrumbItemData';
     ...
     * Sets at_id
     *
     * @param string|null $at_id Breadcrumb URL. It is rewritten where applicable when nhs_links is enabled.
     *
     * @return self
     */
