...
/**
 * ConditionVideoObject Class Doc Comment
 *
 * @category Class
 * @package  Mydex\ApiMrdSdk
 * @author   OpenAPI Generator team
 ...
 */
class ConditionVideoObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConditionVideoObject';
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position < 0)) {
            throw new \InvalidArgumentException('invalid value for $position when calling ConditionVideoObject., must be bigger than or equal to 0.');
        }
