...
/**
 * LivewellVideoObject Class Doc Comment
 *
 * @category Class
 * @description Video content embedded within a Live Well page.
 * @package  Mydex\ApiMrdSdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LivewellVideoObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LivewellVideoObject';
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position < 0)) {
            throw new \InvalidArgumentException('invalid value for $position when calling LivewellVideoObject., must be bigger than or equal to 0.');
        }
