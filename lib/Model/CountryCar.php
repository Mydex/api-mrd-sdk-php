 ...
 */
class CountryCar implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CountryCar';
    ...
    public function getSideAllowableValues()
    {
        return [
            self::SIDE_LEFT,
            self::SIDE_RIGHT,
            self::SIDE_UNKNOWN_DEFAULT_OPEN_API,
        ];
    }
    ...
    {
        $this->setIfExists('signs', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['signs'] === null) {
            $invalidProperties[] = "'signs' can't be null";
        }
    ...
    {
        if (is_null($signs)) {
            throw new \InvalidArgumentException('non-nullable signs cannot be null');
        }
    ...
    public function setSide($side)
    {
        ...
        if (!is_null($side) && !in_array($side, $allowedValues, true)) {
            $side = self::SIDE_UNKNOWN_DEFAULT_OPEN_API;
        }
