...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-mrd.mydex.org';
    ...
    {
        $report  = 'PHP SDK (Mydex\ApiMrdSdk) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api-mrd.mydex.org",
                "description" => "MRD API host.",
            ]
        ];
    }
